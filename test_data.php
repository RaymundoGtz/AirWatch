    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="nosotros.html" class="letras-nav">Alarmas</a></li>
                <li><a href="nosotros.html" class="letras-nav">Perfil</a></li>
                <li><a href="index.html" class="airwatch">AIRWATCH</a></li>
                <li><a href="#"><img src="img/usuarios.png" alt="Imagen de usuario" class="user-image"> </a>
            </ul>
        </nav>
    </header>
